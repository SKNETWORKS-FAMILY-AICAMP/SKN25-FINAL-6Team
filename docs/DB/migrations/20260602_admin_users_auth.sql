...
-- Goal:
-- 1. Introduce a dedicated admin_users table.
-- 2. Move assignment and review-actor references toward admin_id-based storage.
-- 3. Preserve existing string-based fields during the transition window.
