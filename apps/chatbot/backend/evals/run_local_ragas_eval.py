...
def run_one(example: dict[str, Any], metrics: list[str], ticket_id: int) -> dict[str, Any]:
    ...
    row: dict[str, Any] = {
        ...
        "multihop_accepted": outputs.get("multihop_accepted"),
        "multihop_followup_query": outputs.get("multihop_followup_query"),
        "multihop_second_document_count": outputs.get("multihop_second_document_count"),
...
def write_csv(path: Path, rows: list[dict[str, Any]], metrics: list[str]) -> None:
    ...
    fieldnames = [
        ...
        "multihop_accepted",
        "multihop_followup_query",
        "multihop_second_document_count",
